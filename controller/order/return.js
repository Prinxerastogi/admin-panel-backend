    ...
    let condition = [
        {
            $match: {
                ...
                "returnProducts.productId": mongoose.Types.ObjectId(
                    req.body.productId
                ),
            },
        },
    ...
    let condition = [
        {
            $match: {
                ...
                //  'returnProducts.productId': mongoose.Types.ObjectId(req.body.productId),
            },
        },
        {
            $lookup: {
        ...
        (err, updated) => {
            if (err) {
                ...
                return res.status(201).json({
                    success: false,
                    message:
                        "something went wrong in updateOrderreturnProducts ",
                });
            }
        }
    );
