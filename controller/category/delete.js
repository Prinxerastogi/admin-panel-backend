...
let checkCategoryInCategories = (req, res, next) => {
    crudModel.findOne(
        // {
        //     $or: [
        //         { parentId: mongoose.Types.ObjectId(req.query.categoryId) },
        //         { parentIds: mongoose.Types.ObjectId(req.query.categoryId) },
        //         { childIds: mongoose.Types.ObjectId(req.query.categoryId) },
        //     ]
        // },
        {
