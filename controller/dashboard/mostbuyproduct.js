...
let mostBuyProduct = (req, res) => {
    let condition = [
        ...
        {
            $match: {
                "seller.cities": mongoose.Types.ObjectId(req.query.cityId),
        ...
        },
        {
            $addFields: {
                ...
                "sellerProduct.subscriptionQuantity":
                    "$products.subscriptionQuantity",
                "sellerProduct.perUserOrderQuantity":
                    "$products.perUserOrderQuantity",
