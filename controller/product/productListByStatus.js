        ...
        let condition = [
            {
                $match: {
                    _id: filter.subCatId
                        ? mongoose.Types.ObjectId(filter.subCatId)
                        : mongoose.Types.ObjectId(filter.rootCatId),
                    isActive: true,
                },
            },
            //  {
...
let findProductByStatus = (req, res) => {
    ...
    if (filter.leafCatId) {
        condition.push({
            $match: {
                categories: mongoose.Types.ObjectId(filter.leafCatId),
                //{
                //     $in: req.data.subcategory

                //     // [mongoose.Types.ObjectId(filter.subCat) ? mongoose.Types.ObjectId(filter.subCat) : null
                //     //     , mongoose.Types.ObjectId(filter.rootCatId) ? mongoose.Types.ObjectId(filter.rootCatId) : null,
                //     // mongoose.Types.ObjectId(filter.leafCatId)]
                // }
            },
        });
    } else if (filter.subCatId || filter.rootCatId) {
        ...
        condition.push({
            $match: {
                "brand.id": mongoose.Types.ObjectId(filter.brandId),
    ...
    //                     [mongoose.Types.ObjectId(filter.subCat) ? mongoose.Types.ObjectId(filter.subCat) : null
    //                         , mongoose.Types.ObjectId(filter.leafCatId) ? mongoose.Types.ObjectId(filter.leafCatId) : null]
    //             }
    //         }
    //     })
    // }
