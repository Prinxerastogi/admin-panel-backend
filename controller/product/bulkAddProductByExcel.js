          ...
          updateOne: {
            ...
            update: {
              $set: {
                ...
                lDescription: utility.removeSpecialChar(data.description),
                gst: data.gst,
                ...
                sku: data.sku,
                urlKey: utility.removeSpecialCharAndDash(data.urlKey),
                // categoryId: new mongoose.Types.ObjectId('61e69487b009a850f34c4e0d'),
                // categories: new mongoose.Types.ObjectId('61e69487b009a850f34c4e0d'),
              },
            },
          },
        };
        ...
        return {
          insertOne: {
            document: {
              ...
              // categories: new mongoose.Types.ObjectId(data.categoryId),
